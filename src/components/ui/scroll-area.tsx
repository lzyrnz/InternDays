...
>(({ className, orientation = "vertical", ...props }, ref) => (
  <ScrollAreaPrimitive.ScrollAreaScrollbar
    ...
    {...props}
  >
    <ScrollAreaPrimitive.ScrollAreaThumb className="relative flex-1 rounded-full bg-primary/20 backdrop-blur-sm transition-colors hover:bg-primary/40 active:bg-primary/60" />
  </ScrollAreaPrimitive.ScrollAreaScrollbar>
))
